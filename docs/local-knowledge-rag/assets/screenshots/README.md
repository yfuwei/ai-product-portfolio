...
本目录保存本地知识助手 作品集案例使用的脱敏截图。

当前图片由脱敏截图夹具生成，使用 fake `sample-vault` 内容，不包含真实 Obsidian 笔记名、真实 OneDrive 路径、Chroma 数据或私人原始文档。
...
这些截图不是直接从私人索引截取，而是从临时脱敏 HTML 夹具生成。这样既能保留产品界面和工作流，又适合公开发布。
